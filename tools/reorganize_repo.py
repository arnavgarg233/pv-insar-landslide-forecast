...
Run from repo root: python tools/reorganize_repo.py
"""
...
def main() -> None:
    marker = ROOT / "scripts/training/model_b_simple.py"
    if marker.exists():
        print("Already reorganized (scripts/training/model_b_simple.py exists). Skipping.")
        return
